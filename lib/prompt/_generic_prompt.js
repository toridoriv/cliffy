...
import { parse } from "../keycode/key_code.js";
import { bold, brightBlue, dim, green, italic, red, stripColor, yellow, } from "./deps.js";
...
export class GenericPrompt {
    constructor() {
        ...
        _GenericPrompt_readChar.set(this, async () => {
            ...
            const isTty = dntShim.Deno.isatty(this.settings.reader.rid);
            if (isTty) {
    ...
    getDefaultSettings(options) {
        return {
            ...
            reader: options.reader ?? dntShim.Deno.stdin,
            writer: options.writer ?? dntShim.Deno.stdout,
...
function getColumns() {
    try {
        ...
        return dntShim.Deno.consoleSize().columns ?? null;
    }
    catch (_error) {
        return null;
    }
